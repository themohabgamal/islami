        ...
        children: [
          InkWell(
              ...
              child: Expanded(
                flex: 1,
                child: Image(
                    image: sp.currentTheme == ThemeMode.light
                        ? AssetImage("assets/images/masbaha.png")
                        : AssetImage("assets/images/masbaha_dark.png"),width: 210,),
              )),
          SizedBox(
            height: 18,
          ),
            ...
            child: Column(children: [
              ...
              ClipRRect(
                ...
                child: Container(
                    ...
                    color: sp.currentTheme == ThemeMode.light
                        ? MyTheme.primaryColor
                        : MyTheme.blue,
                    child: Text(
                      "$counter",
                      style: sp.currentTheme == ThemeMode.light
